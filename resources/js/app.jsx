        ...
        <div className="relative z-30 max-w-[1000px] mx-auto px-6 -mt-32 md:-mt-24 mb-16">
          ...
          >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full md:w-auto bg-[#121212] hover:bg-black text-white px-10 py-5 rounded-2xl flex items-center justify-center gap-2 shadow-md transition-colors"
            >
              <Search size={20} />
